...
# Beschriftung
labelMenue = Label(master=tkFenster, text="Menü", bg ="white", font=("Arial",18,"bold"))
labelMenue.place(x=45, y= 30)

labelSpieleranzahl = Label(master=tkFenster, text="Spieleranzahl", bg ="white", font=("Arial",14))
labelSpieleranzahl.place(x=45, y=80)

labelMehrspieler = Label(master=tkFenster, text="Mehrspieler", bg ="white", font=("Arial",14))
labelMehrspieler.place(x=45, y=140)

labelSolospieler = Label(master=tkFenster, text="Solo", bg ="white", font=("Arial",14))
labelSolospieler.place(x=220, y=140)

labelEigenschaftenspieler = Label(master=tkFenster, text="Spielereigenschaften einstellen", bg ="white", font=("Arial",14))
...
buttonStart = Button(tkFenster, text="Start", bg ="white", font=("Arial",14), command=tkFenster.quit)
